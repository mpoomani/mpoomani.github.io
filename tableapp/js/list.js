...
function GetBooking() {
    let url = 'https://api.sheety.co/d0d6b43ef27e50083ab03ea0a1897856/bookingApp/bookings';
    fetch(url)
...
function DeleteBooking(id) {
    let url = 'https://api.sheety.co/d0d6b43ef27e50083ab03ea0a1897856/bookingApp/bookings/2' + id;
    fetch(url, {
        method: 'DELETE',
    })
        .then(() => {
